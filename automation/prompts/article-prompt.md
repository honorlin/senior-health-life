...
輸出單一 JSON 物件：
{
  ...
  "inline_images": [{"path":"圖片路徑","alt":"繁體中文替代文字","caption":"圖片說明","placement_after_heading":"段落標題","search_query":"Wikimedia Commons 搜尋詞"}],
  "image_queries": ["至少6個適合 Wikimedia Commons 搜尋、偏真實照片且與主題相關的英文/中文搜尋詞"],
